export const wordList = [
    ...
    { word: "devote oneself to doing sth.", meaning: "投身于做…(devote)" },
    ...
    { word: "aim to do sth.", meaning: "打算做…(a…)" },
    { word: "ask to do sth.", meaning: "要求做…(a…)" },
    { word: "appear to do sth.", meaning: "好像要做…(a…)" },
    { word: "arrange to do sth.", meaning: "安排做…(a…)" },
    { word: "demand to do sth.", meaning: "要求做…(d…)" },
    { word: "happen to do sth.", meaning: "碰巧做…(h…)" },
    { word: "hesitate to do sth.", meaning: "犹豫做…(h…)" },
    { word: "plan to do sth.", meaning: "计划做…(p…)" },
    { word: "wait to do sth.", meaning: "等待做…(w…)" },
    { word: "fail to do sth.", meaning: "未能做…(f…)" },
    { word: "seek to do sth.", meaning: "试图做…(s…)" },
    { word: "prepare to do sth.", meaning: "准备做…(p…)" },
    { word: "decide to do sth.", meaning: "决定做…(d…)" },
    { word: "refuse to do sth.", meaning: "拒绝做…(r…)" },
    { word: "offer to do sth.", meaning: "主动提出做…(o…)" },
    { word: "learn to do sth.", meaning: "学会做…(l…)" },
    { word: "agree to do sth.", meaning: "同意做…(a…)" },
    { word: "choose to do sth.", meaning: "选择/决定做…(c…)" },
    { word: "pretend to do sth.", meaning: "假装做…(p…)" },
    { word: "promise to do sth.", meaning: "答应做…(p…)" },
    { word: "care to do sth.", meaning: "想要做…(c…)" },
    { word: "manage to do sth.", meaning: "设法做…(m…)" },
    { word: "afford to do sth.", meaning: "负担得起做…(a…)" },
    { word: "determine to do sth.", meaning: "决定做…(d…)" },
    { word: "mean to do sth.", meaning: "打算做…(m…)" },
    { word: "prove to do sth.", meaning: "证明做…(p…)" },
    { word: "expect to do sth.", meaning: "期望做…(e…)" },
    { word: "wish to do sth.", meaning: "希望做…(w…)" },
    { word: "hope to do sth.", meaning: "希望做…(h…)" },
    { word: "want to do sth.", meaning: "想要做…(w…)" },
    { word: "long to do sth.", meaning: "渴望做…(l…)" },
    { word: "fear to do sth.", meaning: "害怕做…(f…)" },
    { word: "beg to do sth.", meaning: "请求做…(b…)" },
    { word: "struggle to do sth.", meaning: "努力做…(s…)" },
    { word: "dare to do sth.", meaning: "敢于做…(d…)" },
    { word: "expect to do sth.", meaning: "期望做…(e…)" },
    { word: "force sb.to do sth.", meaning: "强迫某人做…(f…)" },
    { word: "expect sb.to do sth.", meaning: "期望某人做…(e…)" },
    { word: "help sb. (to) do sth.", meaning: "帮助某人做…(h…)" },
    { word: "intend sb.to do sth.", meaning: "打算要某人做…(i…)" },
    { word: "invite sb.to do sth.", meaning: "邀请某人做…(i…)" },
    { word: "want sb. to do sth", meaning: "想要某人做…(w…)" },
    { word: "warn sb. to do sth.", meaning: "警告某人做…(w…)" },
    ...
    { word: "admit doing sth.", meaning: "承认做…(a…)" },
    { word: "advise doing sth.", meaning: "建议做…(a…)" },
    { word: "allow doing sth.", meaning: "允许做…(a…)" },
    { word: "appreciate doing sth.", meaning: "感激做…(a…)" },
    { word: "can't help doing sth.", meaning: "忍不住做…(help)" },
    { word: "consider doing sth.", meaning: "考虑做…(c…)" },
    { word: "delay doing sth.", meaning: "推迟做…(d…)" },
    { word: "there is no denying", meaning: "不可否认(deny)" },
    { word: "deny doing sth.", meaning: "否认做…(d…)" },
    { word: "discuss doing sth.", meaning: "谈论做…(d…)" },
    { word: "dislike doing sth.", meaning: "讨厌做…(d…)" },
    { word: "enjoy doing sth.", meaning: "喜欢做…(e…)" },
    { word: "escape doing sth.", meaning: "逃脱做…(e…)" },
    { word: "excuse doing sth.", meaning: "借口做…(e…)" },
    { word: "explain doing sth.", meaning: "解释做…(e…)" },
    { word: "fancy doing sth.", meaning: "设想做…(f…)" },
    { word: "finish doing sth.", meaning: "完成做…(f…)" },
    { word: "give up doing sth.", meaning: "放弃做…(give)" },
    { word: "forbid doing sth.", meaning: "禁止做…(f…)" },
    { word: "imagine doing sth.", meaning: "想象做…(i…)" },
    { word: "keep doing sth.", meaning: "继续做…(k…)" },
    { word: "mention doing sth.", meaning: "提及做…(m…)" },
    { word: "mind doing sth.", meaning: "介意做…(m…)" },
    { word: "miss doing sth.", meaning: "错过做…(m…)" },
    { word: "pardon doing sth.", meaning: "原谅做…(p…)" },
    { word: "permit doing sth.", meaning: "允许做…(p…)" },
    { word: "practise doing sth.", meaning: "练习做…(p…)" },
    { word: "prevent doing sth.", meaning: "阻止做…(p…)" },
    { word: "prohibit doing sth.", meaning: "禁止做…(p…)" },
    { word: "put off doing sth.", meaning: "推迟做…(p…)" },
    { word: "recall doing sth.", meaning: "想起做…(r…)" },
    { word: "report doing sth.", meaning: "报告做…(r…)" },
    { word: "resist doing sth.", meaning: "拒绝做…(r…)" },
    { word: "risk doing sth.", meaning: "冒险做…(r…)" },
    { word: "suggest doing sth.", meaning: "建议做…(s…)" },
    { word: "understand doing sth.", meaning: "理解做…(u…)" },
    ...
    { word: "confess to doing sth.", meaning: "承认做…(c…)" },
    { word: "look forward to doing sth.", meaning: "期待做…(look)" },
    { word: "object to doing sth.", meaning: "反对做…(o…)" },
    { word: "stick to doing sth.", meaning: "坚持做…(s…)" },
    { word: "take to doing sth.", meaning: "逐渐习惯做…(t…)" },
];
